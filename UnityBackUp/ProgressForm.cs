...
namespace UnityBackUp
{
    ...
    public class ProgressForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Label1
            // 
            this.Label1.Font = new System.Drawing.Font("あずきフォントLP", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
            ...
            // Button1
            // 
            this.Button1.Font = new System.Drawing.Font("あずきフォントLP", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
            ...
            // Label2
            // 
            this.Label2.Font = new System.Drawing.Font("あずきフォントLP", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
            ...
            // ProgressForm
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(9, 18);
            this.ClientSize = new System.Drawing.Size(513, 177);
            this.Controls.Add(this.Label2);
            this.Controls.Add(this.Button1);
            this.Controls.Add(this.ProgressBar1);
            this.Controls.Add(this.Label1);
            this.Font = new System.Drawing.Font("あずきフォントLP", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
    ...
    public class ProgressDialog : IDisposable
    {
        ...
        //進行度メッセージ
        private volatile string _valuemessage = "";
        ...
        public int ValueMessage 
        {
            set 
            {
                _valuemessage = $"{_maximum} / {value}";
                if (form != null)
                    form.Invoke(new MethodInvoker(SetValueMessage));
            }
        }
        ...
        private void Run()
        {
            ...
            form.Label2.Text = $"{_maximum} / {_minimum}";
            //フォームの表示位置をオーナーの中央へ
            if (ownerForm != null)
            {
        ...
        {
            if (form != null && !form.IsDisposed)
                form.Label2.Text = _valuemessage;
        }
